...
const NewItems = () => {
    ...
    // 1- get last 5 created products and store in a state array
    
    // 2 - create a swiper inside a slideshow for each product
    ...
    useEffect(()=>{
        const getLast5Prod = async ()=>{
            const res = await axios.get("http://localhost:5000/api/product/products?last5=true")
            set5(res.data)
        }
